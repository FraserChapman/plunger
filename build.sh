...
echo "Added browser-specific settings to $TMP_XPI_DIR/manifest.json {browser_specific_settings: {gecko: {id: \"plunger@fraser\"}}}"
...
echo "Build $VERSION complete: $BUILD_DIR [plunger@$VERSION.xpi, plunger@$VERSION.zip]"
